...
Other stable targets: `make test-integration`, `make test-e2e`, `make image`, `make frontend-build`, Compose targets. Integration, e2e, image, and Compose are pending later tasks and may print `PENDING:` until those land.
