...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-v0.4.1-ecece8?style=flat-square&labelColor=111111" />
</p>
...
**v0.4.1** — `setuptls generate` extra DNS/IP SANs so a public hostname
or address can verify without dropping the `directory` SAN. Native
