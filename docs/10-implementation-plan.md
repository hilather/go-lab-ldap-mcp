...
- M9 left native ready as opt-in. The omitted-field default is now `native` (ADR-0008 amendment 2026-08-16). Explicit `engine: 389ds` remains the oracle/rollback.
