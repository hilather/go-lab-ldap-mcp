...
| OD-003 | Owner | Project distribution license. | MIT. Root `LICENSE` is the GitHub-detectable project license. Dependency-license policy and notices still apply. | Resolved 2026-08-30. |
...
- Dual engines (`389ds` | `native`) are accepted in ADR-0008 / ADR-0009. As of v0.3.0 the omitted-field default is `native`; `engine: 389ds` remains the oracle and rollback.
