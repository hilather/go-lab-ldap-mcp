...
- `parity/` — dual-engine Contract comparison (M9 / T-147). 389 DS is the oracle. Hermetic native leg is hard-gated in `make verify`; dual-engine (`go test -tags=integration ./test/parity/`) hard-gates when Docker is present.
